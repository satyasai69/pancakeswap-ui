...
export const darkColors = {
  ...baseColors,
  ...additionalColors,
  secondary: "rgb(236, 128, 37)", // "#A881FC",
  secondary80: "rgb(236, 128, 37)", // "#A881FC80",
  background: "#08060B",
  backgroundDisabled: "#3c3742",
  backgroundAlt: "#eddbca", // "#27262c",
  backgroundAlt2: "rgba(39, 38, 44, 0.7)",
  cardBorder: "#eddbca", // "#383241", //
  contrast: "#FFFFFF",
  dropdown: "#1E1D20",
  dropdownDeep: "#100C18",
  ...
  primaryDark: "#0098A1",
  tertiary: "#353547",
  text: "#f0ac73", // "#FFA500", // "#F4EEFF",
  text99: "#f0ac73", // "#FFA500", // "#F4EEFF99",
  textDisabled: "#666171",
  textSubtle: "#B8ADD2",
  disabled: "#524B63",
  gradientPrimary: "linear-gradient(228.54deg, #1FC7D4 -13.69%, #9A6AFF 91.33%)",
  gradientBubblegum: "#FFFFFF", // "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)", //sai col
